...
import org.fitnessConstructor.utils.EmailNotExist
import org.fitnessConstructor.utils.FillInputCorrect
import org.fitnessConstructor.utils.PasswordNotMatch
            ...
            when (error) {
                ...
                is PasswordNotMatch -> {
                    call.respond(
                        ...
                        ApiResponse.failure(Response.Alert(title = "Failed", message = "Password is wrong", errorCode = error.code), HttpStatusCode.BadRequest)
                    )
                }
